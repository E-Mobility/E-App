...
public class BluetoothDiscoveryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ListView newDevicesListView = (ListView) findViewById(R.id.deviceList_deviceList);
		...
		if (pairedDevices.size() > 0) {
			...
			String noDevices = getResources().getText(
					R.string.deviceList_noPairedDevices).toString();
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				if (mNewDevicesArrayAdapter.getCount() == 0) {
					String noDevices = getResources().getText(
							R.string.deviceList_noDevices).toString();
